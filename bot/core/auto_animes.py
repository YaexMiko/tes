...
async def get_animes(name, torrent, force=False):
    try:
        ...
        if force or (not (ani_data := await db.getAnime(ani_id)) \
            ...
            await asleep(1.5)
            stat_msg = await sendMessage(Var.MAIN_CHANNEL, f"<blockquote>‣ <b>𝙰𝚗𝚒𝚖𝚎 𝙽𝚊𝚖𝚎 :</b> <b>{name}</b>\n\n𝙳𝚘𝚠𝚗𝚕𝚘𝚊𝚍𝚒𝚗𝚐...</blockquote>")
            ...
            for qual in Var.QUALS:
                ...
                await editMessage(stat_msg, f"‣ <blockquote><b>𝙰𝚗𝚒𝚖𝚎 𝙽𝚊𝚖𝚎 :</b> <b>{filename}</b>\n\n𝚁𝚎𝚊𝚍𝚢 𝚃𝚘 𝚄𝚙𝚕𝚘𝚊𝚍...</blockquote>")
                await asleep(1.5)
                try:
